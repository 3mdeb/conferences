...
- 2 most well known implementations use special CPU instruction to trigger D-RTM
...
- Since Xen can control `VMEXIT_{SKINIT,SENTER}` we have to reestablish trust in
