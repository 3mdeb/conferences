...
- Security features
    + Secure Boot (RoT for the whole server) flash monitoring and
      protection, attestation of firmware and hardware components
...
* What caugth my attention was that no layer management tool was used here.
