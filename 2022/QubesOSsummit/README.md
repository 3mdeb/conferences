...
```shell
cd existing_repo
git remote add origin https://gitlab.com/3mdeb/conferences/2022/qubesos-summit-2022.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/3mdeb/conferences/2022/qubesos-summit-2022/-/settings/integrations)
...
The sections used in the template are suggestions for most open source
