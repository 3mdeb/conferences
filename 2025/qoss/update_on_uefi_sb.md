...
<li>[The Xen architecture allows for the creation of more secure
systems](https://doc.qubes-os.org/en/latest/introduction/faq.html#why-does-qubes-use-xen-instead-of-kvm-or-some-other-hypervisor),
but nothing is always 100% secure forever.<br>
...
At the very least have a working infrastracture for when certain technical
...
<li> Following coming from discussion with Andrew:
  ...
  options may be unsafe):
    <ul>
    <li> <code>ima_appraise</code> - integrity measurements
    <li> <code>lockdown</code> - kernel lockdown feature
    <li> <code>spec-ctrl</code> - controls for speculative execution
